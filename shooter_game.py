...
FPS = 60
font.init()
fnt = font.SysFont('Arial', 170)
fntMidle = font.SysFont('Arial', 70)
fntSmall = font.SysFont('Arial', 35)
...
#Установить библеотеку pyinstaller
    #pip install pyinstaller
#сформировать exe файл
    #pyinstaller --onefile shooter_game.py
#не забыть положить карттинки и музыку в папку с exe-файлом